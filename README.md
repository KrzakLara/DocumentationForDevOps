...
4, Updating HTML Content: " docker exec web8080 sh -c 'echo "<html><body><h1>New Content</h1><p>This is the updated default page.</p></body></html>" > /var/www/html/index.html' "
