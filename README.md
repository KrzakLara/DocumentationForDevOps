...
| 8. Push Images to Docker Hub | `podman login --username yourusername docker.io`<br>`podman tag getting-started-app:0.0.1 docker.io/yourusername/getting-started-app:0.0.1`<br>`podman push docker.io/yourusername/getting-started-app:0.0.1` <br>`podman push getting-started-app:0.0.2 docker.io/yourusername/getting-started-app:0.0.2` <br>`podman push docker.io/yourusername/getting-started-app:0.0.1`| Log in to Docker Hub and push the images tagged 0.0.1 and 0.0.2 to Docker Hub. |
